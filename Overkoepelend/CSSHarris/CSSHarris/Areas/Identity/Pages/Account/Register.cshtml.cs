...
namespace CSSHarris.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        /// <returns></returns>
        private async Task<bool> VerifyCaptcha(string ResponseUser)
        {
            ...
            return (bool)JsonConvert.DeserializeObject<JObject>(response)["success"];
        }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                if (await VerifyCaptcha(Input.Captcha))
                {
                    var user = CreateUser();
